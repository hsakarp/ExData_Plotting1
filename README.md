#The description of 9 variables in the dataset taken from the UCI web site:
...
As per the instruction dates from 2007-02-01 and 2007-02-02 are taken.

The corresponding R file creates the corresponding png file(for example Plot1.R creates Plot1.R)
